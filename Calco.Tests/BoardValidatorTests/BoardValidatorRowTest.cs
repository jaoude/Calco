...
{
    public class BoardValidatorRowTest
    {
        private IBoardValidator     _boardValidatorRow;

        public BoardValidatorRowTest()
        {
        }
        ...
        public void AssertIsValid()
        {
            ...
            _boardValidatorRow = new BoardValidatorRow(values);

            // Run
            var result = _boardValidatorRow.IsValid();
        ...
        public void AssertIsNotValid()
        {
            ...
            // Assert
            Assert.AreEqual(result, DUPLICATES_IN_ROW_ERROR);
        }
    }
}
