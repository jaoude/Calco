...
{
    public class BoardValidatorBoxTest
    {
        private IBoardValidator _boardValidatorBox;

        public BoardValidatorBoxTest()  { }
        ...
        public void AssertIsValid()
        {
            ...
            _boardValidatorBox = new BoardValidatorBox(values);

            // Run
            var result = _boardValidatorBox.IsValid();
        ...
        public void AssertIsNotValid()
        {
            ...
            // Assert
            Assert.AreEqual(result, DUPLICATES_IN_BOX_ERROR);
        }
    }
}
