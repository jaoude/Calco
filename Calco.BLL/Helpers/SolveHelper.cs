...
namespace Calco.BLL.Helpers
{
    public class SolveHelper : ISolveHelper
    {
        ...
        //public void Solve(Board board, LinkedListNode<Square> square, List<int> values, int idx)
        //{
        ...
        //    if (square == null)
        //    {
        //        square = board.LinkedSquares.First;
        //        while (square != board.LinkedSquares.Last)
        //        {
        //            if (!square.Value.Val.HasValue)
        //                break;
        //        }
        //        square = square.Next;
        //    }
